...
function setup_cartellino () {
  ...
  // evidenzia riposi
  $('#gvCartellino_DXMainTable tbody tr.cart_cell td:nth-child(2)[style*="rgb(0, 0, 255)"],'+
    '#gvCartellino_DXMainTable tbody tr.cart_cell td:nth-child(2)[style*="#0000ff"]').
    parent().css('background-color', 'lightblue');
  $('#gvCartellino_DXMainTable tbody tr.cart_cell td:nth-child(2)[style*="rgb(255, 0, 0)"],'+
    '#gvCartellino_DXMainTable tbody tr.cart_cell td:nth-child(2)[style*="#ff0000"]').
