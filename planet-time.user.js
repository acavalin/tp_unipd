...
function setup_cartellino () {
  ...
  // evidenzia riposi
  $('#gvCartellino_DXMainTable tbody tr.cart_cell td:nth-child(2)[style^="color: rgb(0, 0, 255)"]').
    parent().css('background-color', 'lightblue');
  $('#gvCartellino_DXMainTable tbody tr.cart_cell td:nth-child(2)[style^="color: rgb(255, 0, 0)"]').
